...
* The delivery address and receiving process
* Whether MLH expects to ship an event pack
* Which partner categories apply
...
Depending on availability, an event pack may include:

* MLH logo stickers
* MLH season stickers
* “Hack Day—I Demoed” stickers for hackers who present projects
* MLH partner swag
* Physical partner prizes
...
Follow [Closing Ceremony and Winner Declaration](event-planning-guide/closing-ceremony-and-winner-declaration.md) for the required workflow. Confirm that the correct project is marked **Winner** under each partner challenge so MLH can follow up when required.
