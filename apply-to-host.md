---
description: Create and complete a Hack Day application, then move into event management after approval.
---
...
<figure><img src=".gitbook/assets/organizerhq/application-event-details.png" alt="Initial Hack Days application form with event nickname, date, time, and time zone fields"><figcaption><p>Enter the basic event details to create the application.</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/organizerhq/application-steps.png" alt="Hack Days application workspace showing the required application steps"><figcaption><p>Complete each Hack Days application step and check that it shows as submitted.</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/organizerhq/application-approved.png" alt="Approved Hack Days application with the Visit Event Management Dashboard button"><figcaption><p>Once approved, move into the event management dashboard to prepare the public event page.</p></figcaption></figure>
